...
class AppController {
  constructor() {
    this.projects = _Storage_js__WEBPACK_IMPORTED_MODULE_2__["default"].load() || [new _Project_js__WEBPACK_IMPORTED_MODULE_0__["default"]('default', 'Default Project')];
    this.activeProjectId = this.projects[0].id;
  }

  save() {
    _Storage_js__WEBPACK_IMPORTED_MODULE_2__["default"].save(this.projects);
  }

  addProject(name) {
    const project = new _Project_js__WEBPACK_IMPORTED_MODULE_0__["default"](null, name);
  ...
  addTodo(title, desc, date, priority, notes) {
    const todo = new _Todo_js__WEBPACK_IMPORTED_MODULE_1__["default"](null, title, desc, date, priority, notes);
...
class DOM {
  ...
  renderTodos() {
    ...
    activeProject.todos.forEach(todo => {
      ...
      const formattedDate = todo.dueDate ? (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parseISO)(todo.dueDate), 'MMM do, yyyy') : 'No Date';
...
class Storage {
  ...
  static load() {
    ...
    return parsed.map(pData => {
      const project = new _Project_js__WEBPACK_IMPORTED_MODULE_0__["default"](pData.id, pData.name);
